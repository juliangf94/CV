const cvData = {
    ...
    experiences: [
        ...
        },
        {
            ...
            period: "fév. – mars 2023 (4 semaines)",
            location: "Rennes, France",
            bullets: [
                "Optimisé la performance applicative de <strong>25%</strong> en concevant une API RESTful avec <strong>FastAPI</strong> et en automatisant le déploiement via Docker.",
                "Conçu des composants front-end en React et intégré des services via la Fetch API.",
                "Configuré et déployé le serveur web <strong>Caddy</strong> sur une instance Oracle Cloud.",
            ],
        },
    ],
    ...
    projects: [
        {
            ...
            desc: "Développé une application web full stack reproduisant les fonctionnalités principales d'AirBnB, incluant un ORM personnalisé, l'implémentation complète du CRUD via une <strong>API REST (Flask)</strong>, et un front-end dynamique avec intégration MySQL.",
        },
        {
            ...
            desc: "Développé un interpréteur de commandes UNIX en C, intégrant la gestion des processus (fork, execve) et la résolution dynamique du PATH. Zéro fuite mémoire (Valgrind).",
        },
        {
            ...
            desc: "Conçu et implémenté une bibliothèque C personnalisée gérant les fonctions variadiques et le formatage complexe de données (10+ spécificateurs de format).",
        },
    ],
